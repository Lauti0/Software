    ...
    public partial class FrmInicioSesion_22MS : Form
    {
        ...
        private void btnIniciarSesion_22MS_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (modoReparacionDV_22MS)
                {
                    if (usuario.Rol_22MS == null || usuario.Rol_22MS.NombreRol_22MS != "Admin")
                    {
                        MessageBox.Show(
                            "Mientras persista la inconsistencia, solo un administrador puede acceder a las funciones de reparación.",
                            "Acceso denegado",
                    ...
                    MessageBox.Show("Administrador validado. Accediendo a reparación de dígito verificador.");
                    ...
                    bitacoraEvento.RegistrarEvento_22MS(
                        ...
                        "Dígito Verificador",
                        "Ingreso en modo reparación de dígito verificador",
                        2
                    );
