...
namespace BLL_22MS
{
    ...
    = new Dictionary<string, (int, DateTime)>();
        ...
        public void InsertarUsuario_22MS(string apellido, string nombre, string dni, Rol_22MS rol, string email)
        {                        
        ...
        public void ModificarUsuario_22MS(string dni, string email, Rol_22MS rol)
        {            
